...
export default function TireInformation() {
  return (
    <section className="tire-information">
      <div className="wrap">
        <Image className="service-hero-image tire-overview-image" src="/images/tires/reifen-raeder.jpg" alt="" width={1200} height={280} sizes="(max-width: 900px) 100vw, 1200px" />
